    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl shadow-blue-100/50 border border-blue-200/30 mb-8">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-3xl font-poppins font-bold bg-gradient-to-r from-green-700 to-emerald-700 bg-clip-text text-transparent">
                        Crear Nuevo Proyecto
                    </h1>
                    <p class="text-gray-600 font-medium">Completa los datos para registrar un nuevo proyecto</p>
                </div>
            </div>
        </div>
        ...
        <!-- Formulario -->
        <form action="{{ route('proyectos.store') }}" method="POST" class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl shadow-blue-100/50 border border-blue-200/30 overflow-hidden">
            @csrf

            <!-- Encabezado del Formulario -->
            <div class="px-8 py-6 bg-gradient-to-r from-blue-600/10 to-purple-600/10 border-b border-blue-200/30">
                ...
                <p class="text-gray-600 mt-1">Ingresa los detalles básicos del proyecto</p>
            </div>
            ...
            <div class="p-8 space-y-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div class="lg:col-span-2">
                        ...
                        <input type="text" name="NombreProyecto" value="{{ old('NombreProyecto') }}"
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <input type="text" name="fuenteFondos" value="{{ old('fuenteFondos') }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" name="MontoPlanificado" value="{{ old('MontoPlanificado') }}"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-4 text-gray-500 font-bold">$</div>
                                <input type="number" step="0.01" name="MontoPatrocinado" value="{{ old('MontoPatrocinado') }}"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-4 text-gray-500 font-bold">$</div>
                                <input type="number" step="0.01" name="MontoFondosPropios" value="{{ old('MontoFondosPropios') }}"
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                    ...
                    <button type="submit"
                            class="group flex items-center space-x-2 px-8 py-3 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-bold rounded-xl shadow-lg shadow-green-200 hover:shadow-xl hover:shadow-green-300 transition-all duration-200 transform hover:-translate-y-0.5">
